---
title: "Deployment Export Format"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Deployment Export Format}
...
The RF tree dump JSON is intended to help collaborators recreate the trained model logic outside R.

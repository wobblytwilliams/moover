...
If your observation file uses friendly names like `animal_id` and `start_time`, map them in the spec:
...
With raw files and observation labels ready, continue to [Build Your First Behaviour Model](build-a-model.html).

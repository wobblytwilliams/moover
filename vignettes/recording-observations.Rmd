...
vignette: >
  %\VignetteIndexEntry{Recording Observations}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

Training models requires an observation table describing behaviour bouts.
...
If your table uses different column names or ISO timestamps, you can map them in the spec:
